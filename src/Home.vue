				...
				<el-space direction="horizontal" size="large">
					<el-menu mode="horizontal" :default-active="route.path" @select="onMenuItemSelect"
						...
						<el-menu-item index="/tasks">
							<el-badge v-if="badgeStore.all_task_count > 0" :value="badgeStore.all_task_count"
								type="primary" :offset="[0, 10]">
								Tasks
							</el-badge>
							<span v-else>Tasks</span>
						</el-menu-item>
						<el-menu-item index="/notices">
							<el-badge v-if="badgeStore.all_notice_count > 0" :value="badgeStore.all_notice_count"
								:max="999" :offset="[0, 10]">
								Notices
							</el-badge>
						...
						<el-sub-menu index="groups">
							...
							<el-menu-item index="/fav_folders">Actor Fav Folders</el-menu-item>
