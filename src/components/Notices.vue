    ...
    <el-container>
        ...
        <el-main>
            <el-space direction="vertical" v-if="is_search">
                ...
                <el-space>
                    <el-table :data="notice_list" class="wrap_line" border>
                        <el-table-column v-for="col in notice_columns" :key="col.prop_name" :prop="col.prop_name"
                                         :label="col.col_name" :width="200"/>
                    </el-table>
                </el-space>
            </el-space>
...
import {NoticeColumn} from "../data/Interfaces";
...
export default {
    ...
    data() {
        return {
            cur_notice_type: 0,
            notice_columns: [] as NoticeColumn[],
    ...
    methods: {
        ...
        async onNoticeTypeChange(index: string) {
            ...
            this.notice_columns = Notice_Param_Names[this.cur_notice_type]
