	...
	<el-space direction="vertical" class="limit-form">
		...
		<el-form :model="download_limit" label-width="200px" label-position="left">
			...
			<el-form-item label="Post Filter">
				<el-radio-group v-model="download_limit.post_filter" @change="onPostFilterChange">
					<el-radio v-for="pf in post_filter_list" :value="pf.value">
						{{ pf.label }}
					</el-radio>
				</el-radio-group>
			</el-form-item>
			...
			<el-form-item label="Res Type">
				<el-radio-group v-model="download_limit.res_type" @change="onResTypeChange">
					<el-radio v-for="pf in res_type_list" :value="pf.value">
						{{ pf.label }}
					</el-radio>
				</el-radio-group>
			</el-form-item>
			...
			<el-form-item label="Single Res Size(MB)">
				...
				<el-radio-group v-model="download_limit.show_single_file_size" class="common-border">
					<el-radio :value="0" size="small">All</el-radio>
					<el-radio :value="1" size="small">Info</el-radio>
					<el-radio :value="4" size="small">Image</el-radio>
					<el-radio :value="1024" size="small">Video</el-radio>
				</el-radio-group>
				<el-text>
					({{ download_limit.show_single_file_size  }} MB)
				</el-text>
			</el-form-item>
		</el-form>
	</el-space>
